...
<p align="center">
  <em style="color: #CCCCCC;">
    <span style="color: #8A2BE2;">Crafting elegant code</span> and 
    <span style="color: #00CED1;">immersive stories</span>—on screen or in the terminal.
  </em>
</p>
<br />
...
<details>
  <summary style="color: #FFFFFF; cursor: pointer;">I’m always up for tackling:</summary>
  <ul style="color: #DDDDDD;">
    <li>🔹 Python back-ends (Django, Flask, FastAPI)</li>
    <li>🔹 C++ algorithm challenges (DSA, competitive programming)</li>
    <li>🔹 Sleek, responsive web applications (React, Next.js, TailwindCSS)</li>
    <li>🔹 AI/ML integrations (spaCy, Transformers, Scikit-learn)</li>
  </ul>
</details>
...
<details>
  <summary style="color: #FFFFFF; cursor: pointer;">📚 More About Me</summary>
  <ul style="color: #DDDDDD;">
    <li>🎯 <strong style="color: #00CED1;">Goal:</strong> Ship polished, production-ready code & cinematic multimedia</li>
    <li>🧠 Continuously exploring algorithmic patterns and UX design trends</li>
    <li>🌐 Fluent in both human and programming languages</li>
    <li>🎥 Storyboarding & editing creative videos for “Peru 24/7” and beyond</li>
  </ul>
</details>
